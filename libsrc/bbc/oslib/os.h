...
/* different to Risc OS! uses byte and longer buffer */
struct os_error
   {  byte errnum;
      char errmess [254];
   };
...
#define os_PLATFORM32_BIT_OS                    ((os_platform_feature_flags) 0x20u)
      /*RISC O S 5+*/
#define os_PLATFORM26_BIT_MODE_NOT_AVAILABLE    ((os_platform_feature_flags) 0x40u)
      /*RISC O S 5+*/
...
extern void *os_unused_swi (void const *unused_swi_handler);
...
extern os_error *xos_remove_ticker_event (void const *code,
      byte *handle);
extern void os_remove_ticker_event (void const *code,
      byte *handle);
...
extern os_error *xos_add_call_back (void const *call_back,
      byte *handle);
extern void os_add_call_back (void const *call_back,
      byte *handle);
...
extern os_error *xos_remove_call_back (void const *call_back,
      byte *handle);
extern void os_remove_call_back (void const *call_back,
      byte *handle);
