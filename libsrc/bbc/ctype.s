...
;
; BBC character specification table.
;
; __ctypeidx packs two 4-bit indices per byte (see ct_mix in ctypetable.inc).
; ctypemask (libsrc/common/ctypemask.s) loads __ctypeidx[c>>1] and picks the
; low or high nibble for even/odd c, then indexes __ctype for the real mask.
;

; see page 229 of the BBC Microcomputer System User Guide for codes below
...
__ctypeidx:
        ...
        ct_mix  CT_NONE_IDX, CT_CTRL_WS_IDX              ; 126/7e _____~_____, 127/7f ____DEL____
